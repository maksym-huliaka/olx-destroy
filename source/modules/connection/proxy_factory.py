...
def get_proxy():
    driver = get_driver("")
    driver.get("https://hidemy.name/ru/proxy-list/?country=ALAMATAZBYBEBGCYCZEGFIFRGEDEGRHUIRIEILITLVLTMKMUMDNLNOPLPTRORURSSKESCHSYTRUAGBUZ&maxtime=700&type=hs#list")
    time.sleep(6)
